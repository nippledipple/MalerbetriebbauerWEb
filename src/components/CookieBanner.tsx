...
const CookieBanner: React.FC = () => {
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center space-x-3">
              <Cookie className="text-blue-500" size={32} />
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 z-50 p-6 shadow-2xl">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-start space-x-3 flex-1">
            <Cookie className="text-blue-500 flex-shrink-0 mt-1" size={32} />
            <div>
              <h3 className="font-bold text-white mb-2">
                Diese Webseite verwendet Cookies, um die Nutzung zu verbessern.
              </h3>
            </div>
          </div>
